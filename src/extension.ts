...
function getInventoryManagementHtml(webview: vscode.Webview, extensionUri: vscode.Uri): string {
    const htmlPath = vscode.Uri.joinPath(extensionUri, 'webview', 'inventory_management.html');
